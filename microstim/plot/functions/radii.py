...
boost = gamma.copy()
_, _, rho_e, rho_i, _, _ = model(intensity, weights, sigma, sigmoidalRect, boost, is_depolarized=False)
...
# _, _, no_amp, _, _, _ = model(intensity, weights, sigma, sigmoidalRect, no_boost, is_depolarized=True)
