...
# unstable
weights["e->i"], weights["i->i"], start_boost["inh"] = 125, 100, 0.5
unstable_rho_e, unstable_rho_i, unstable_v_e, unstable_v_i = depolarizationModel(intensity, weights, sigma, start_boost)
